...
class UserSignUpSerializer(serializers.Serializer):
    ...
    def create(self, data):
        ...
        user = User.objects.create_user(**data, is_verified=False, is_active=True)
    ...
    def send_confirmation_email(self,user):
        ...
        subject, from_email, to = f'hello @{user.username}', 'Comparte Ride <noreply@comparteride.com>', f'{user.email}'
